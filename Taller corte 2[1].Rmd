...
```{r}
# 1. Cargar la librería recomendada
library(readr)

# 2. Leer el archivo CSV (ajusta la ruta a la tuya)
data_collisions <- read_csv("C:/Users/brand/OneDrive/Escritorio/UNIVERSIDAD/ESTEXPLOTARIA/combined_collisions_v3.csv")

# 3. Revisar los nombres de las columnas para confirmar el nombre correcto
# names(data_collisions)

# 4. Calcular límites IQR (asegúrate que la columna se llama igual que aquí)
